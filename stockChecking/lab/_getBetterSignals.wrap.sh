year=${1:-2025}
forecast_data=/home/limin/forecast/gold/.t3.segData.lvl3.all.forword
#forecast_data=/home/limin/forecast/gold/.t3.segData.lvl4.all
top_value=top566.lst

#for i in {0,500,1000,1500}; do
for i in 0; do
    from=$i;
    to=$((from+500));
    better_signals_org=.t3.$year.$from.to.$to;
    better_signals=.lvl3.better.signals.$year.$from.to.$to;
