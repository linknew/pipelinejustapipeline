...
#output:\n\
#\t(1)sorting (2)upAMPCeiling (3)upAMPFloor (4)dnAMPCeiling (5)dnAMPFloor (6)durAmp (7)dateStart (8)dateEnd (9)srcFile"
...
./serialize.sh --seed=1 \
               ...
               --format='"%-27s %6.2f%% %6.2f%% %6.2f%% %6.2f%% %6.2f%% %10s %10s %10s %s\n",$1,$18,$19,$20,$21,$22,$23,$24,$3,$30'
