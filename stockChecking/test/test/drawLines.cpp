...
typedef int(*digtFuncPt)(char digitalKey, bool& refresh);
int digtFuncBaselineFilter( char c, bool& refresh );
int digtFuncLineFilter( char c, bool& refresh );
int digtFuncScale( char c, bool& refresh );
...
static unsigned int     baseLineSwitchers = (0) ;     // if (MAX_SUPPORTTED_LINES > sizeof(int)*8), this maybe take you to a fault!!
static unsigned int     linesSwitchers = ((1<<6)-1);   // comments here, same with above line's!!
        ...
        )
{
    switch( c ){
        ...
        case '5' : case '6' : case '7' : case '8' :
            ...
            dtlsIdxOnMainView = min(_linesData.cols, GET_NUMBERS_PER_SCREEN(_mainView.cols,c-'0')) -
            ...
            break ;
        case '9' :
            dtlsIdxOnMainView = min(_linesData.cols, GET_NUMBERS_PER_SCREEN(_mainView.cols,1)) -
                                    min(_linesData.cols, GET_NUMBERS_PER_SCREEN(_mainView.cols,scale)) +
                                    dtlsIdxOnMainView ;
            scale = 1 ;
            refresh = true ;
        ...
        )
{
    switch( c ){
        case '1' : case '2' : case '3' : case '4' :
        case '5' : case '6' : case '7' : case '8' :
            REVERT_SWITCH(linesSwitchers,c-'0'-1) ;
            refresh = true ;
            break ;
        ...
        )
{
    switch( c ){
        case '1' : case '2' : case '3' : case '4' :
        case '5' : case '6' : case '7' : case '8' :
            REVERT_SWITCH(baseLineSwitchers,c-'0'-1) ;
            refresh = true ;
            break ;
        case '9' :
        ...
        )
{
    ...
    return digtFuncList[ digtFuncIdx ](c, refresh) ;
}
