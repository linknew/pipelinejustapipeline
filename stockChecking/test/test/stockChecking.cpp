            ...
            /* redraw daily keyline info at the left view */
            {
                ...
                /* close, open, max, min, date */
                {
                    ...
                    for( _i = 0 ; _i < _m.rows; _i++ ){
                        ...
                        line( gLeftDetailsView, Point(8, _basePosY-_ceiling), Point(gLeftDetailsView.cols-1-58, _basePosY-_ceiling), Scalar(127,127,127), 0, LINE_8) ;
                        line( gLeftDetailsView, Point(8, _basePosY-_ystdClose), Point(gLeftDetailsView.cols-1-58, _basePosY-_ystdClose), Scalar(127,127,127), 0, LINE_8) ;
                        line( gLeftDetailsView, Point(8, _basePosY-_floor), Point(gLeftDetailsView.cols-1-58, _basePosY-_floor), Scalar(127,127,127), 0, LINE_8) ;
