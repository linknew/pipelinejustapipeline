...
function Help
{
    ...
    Usage: ${0} [--revert] [--skipNewBorn=N] [--start=YY-MM-DD] [--end=YY-MM-DD] [--taxRatPrt=F] [--taxRatHandFee=F] [--fltCode=S] [--fltSeed=S] 
                     [[--dispPruneData [--noAbb] [--keepNoneItem] [--noSorting]] | [--dispProfit [--verbose]] | [--dispSyncProfit] ]
                     [--help] 
                     pattern segFile
